...
Version 3.0 is basically the same as version 2.1, but it has been optimized for the ESP32 EFIS-EMS. Version 2.1 should still be used with the Teensy EFIS.
